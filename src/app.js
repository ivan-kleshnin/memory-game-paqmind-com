...
let renderCell = curry((i, j, cell) => {
  let cellAttrs = {attrs: {"data-row": i, "data-col": j}, key: String(i) + "-" +String(j)}
  if (cell[1] == 0) {
    // closed
