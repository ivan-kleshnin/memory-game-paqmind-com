...
let renderCell = curry((i, j, cell) => {
  ...
  if (cell[1] == 0) {
    ...
    return span(".cell", cellAttrs,
      span(".card.flipper.shaker", {attributes: {"data-state": 0}}, [
        span(".front", "?"),
        span(".back", cell[0]),
      ])
    )
    ...
    // opened
    return span(".cell", cellAttrs,
      span(".card.flipper.shaker.flipped", {attributes: {"data-state": 1}}, [
        span(".front", "?"),
        span(".back", cell[0]),
      ])
    )
    ...
    // done
    return span(".cell", cellAttrs,
      span(".card.flipper.shaker.flipped.hidden", {attributes: {"data-state": 2}}, [
        span(".front", "?"),
        span(".back", cell[0]),
      ])
    )
